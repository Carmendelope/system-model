...
func (sap *ScyllaApplicationNetworkProvider) GetConnectionByZtNetworkId(organizationId string, ztNetworkId string) ([]entities.ConnectionInstance, derrors.Error){
	sap.Lock()
	defer sap.Unlock()
