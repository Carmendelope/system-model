...
func (m *MockupOrganizationProvider) Remove(organizationID string) derrors.Error {
	m.Lock()
	defer m.Unlock()
	...
	delete(m.organizations, organizationID)
	delete(m.organizationNames, organizationName)
	return nil
}
